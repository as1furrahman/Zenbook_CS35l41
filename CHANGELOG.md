...
> **Note**: Release entries for v1.0.0 through v1.3.1 document internal development history and forum iterations. Git tags correspond to verified repository releases: `v1.2.0`, `v1.2.1`, and `v1.4.0`.
